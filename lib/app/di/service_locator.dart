...
import 'package:volleyapp/features/auth/data/datasources/firebase_auth_state_source.dart'; // adapter Firebase -> port
import 'package:volleyapp/features/session/domain/session_state_provider.dart';

final locator = GetIt.instance;

Future<void> configureDependencies() async {
  // --- tes registres existants ---
  ...
  // --- AJOUTS pour la navigation guardée ---
  ...
  locator.registerLazySingleton<SessionStateProvider>(
        () => SessionStateProvider(locator<AuthStateSource>()),
  );
}
